	...
	function DeleteRows() {
		...
		if ($DeleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$OldFiles = ew_Empty($row['section_01_image']) ? array() : array($row['section_01_image']);
				$OldFileCount = count($OldFiles);
				for ($i = 0; $i < $OldFileCount; $i++) {
					if (file_exists($this->section_01_image->OldPhysicalUploadPath() . $OldFiles[$i]))
...
<?php if ($about_us->id->Visible) { // id ?>
		<th class="<?php echo $about_us->id->HeaderCellClass() ?>"><span id="elh_about_us_id" class="about_us_id"><?php echo $about_us->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($about_us->section_01_title->Visible) { // section_01_title ?>
		<th class="<?php echo $about_us->section_01_title->HeaderCellClass() ?>"><span id="elh_about_us_section_01_title" class="about_us_section_01_title"><?php echo $about_us->section_01_title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($about_us->section_01_title_ar->Visible) { // section_01_title_ar ?>
		<th class="<?php echo $about_us->section_01_title_ar->HeaderCellClass() ?>"><span id="elh_about_us_section_01_title_ar" class="about_us_section_01_title_ar"><?php echo $about_us->section_01_title_ar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($about_us->section_01_image->Visible) { // section_01_image ?>
		<th class="<?php echo $about_us->section_01_image->HeaderCellClass() ?>"><span id="elh_about_us_section_01_image" class="about_us_section_01_image"><?php echo $about_us->section_01_image->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($about_us->id->Visible) { // id ?>
		<td<?php echo $about_us->id->CellAttributes() ?>>
<span id="el<?php echo $about_us_delete->RowCnt ?>_about_us_id" class="about_us_id">
...
<?php } ?>
<?php if ($about_us->section_01_title->Visible) { // section_01_title ?>
		<td<?php echo $about_us->section_01_title->CellAttributes() ?>>
<span id="el<?php echo $about_us_delete->RowCnt ?>_about_us_section_01_title" class="about_us_section_01_title">
...
<?php } ?>
<?php if ($about_us->section_01_title_ar->Visible) { // section_01_title_ar ?>
		<td<?php echo $about_us->section_01_title_ar->CellAttributes() ?>>
<span id="el<?php echo $about_us_delete->RowCnt ?>_about_us_section_01_title_ar" class="about_us_section_01_title_ar">
...
<?php } ?>
<?php if ($about_us->section_01_image->Visible) { // section_01_image ?>
		<td<?php echo $about_us->section_01_image->CellAttributes() ?>>
<span id="el<?php echo $about_us_delete->RowCnt ?>_about_us_section_01_image" class="about_us_section_01_image">
<span>
