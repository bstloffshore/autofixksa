...
$campaign_aboutus_edit = NULL; // Initialize page object first

class ccampaign_aboutus_edit extends ccampaign_aboutus {
	...
	// Page object name
	var $PageObjName = 'campaign_aboutus_edit';
	...
	function RenderRow() {
		...
		$this->section_04_icon->ViewCustomAttributes = "";
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->sliderImage);
			...
			if ($this->CurrentAction == "I" && !$this->EventCancelled) ew_RenderUploadField($this->sliderImage_ar);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			if ($this->sliderImage->Visible && !$this->sliderImage->ReadOnly && !$this->sliderImage->Upload->KeepFile) {
				$this->sliderImage->Upload->DbValue = $rsold['sliderImage']; // Get original value
			...
			// sliderImage_ar
			if ($this->sliderImage_ar->Visible && !$this->sliderImage_ar->ReadOnly && !$this->sliderImage_ar->Upload->KeepFile) {
				$this->sliderImage_ar->Upload->DbValue = $rsold['sliderImage_ar']; // Get original value
			...
			// section_01_icon
			$this->section_01_icon->SetDbValueDef($rsnew, $this->section_01_icon->CurrentValue, NULL, $this->section_01_icon->ReadOnly);

			// section_02_title
			$this->section_02_title->SetDbValueDef($rsnew, $this->section_02_title->CurrentValue, NULL, $this->section_02_title->ReadOnly);

			// section_02_title_ar
			$this->section_02_title_ar->SetDbValueDef($rsnew, $this->section_02_title_ar->CurrentValue, NULL, $this->section_02_title_ar->ReadOnly);
			...
			// section_02_icon
			$this->section_02_icon->SetDbValueDef($rsnew, $this->section_02_icon->CurrentValue, NULL, $this->section_02_icon->ReadOnly);

			// section_03_title
			$this->section_03_title->SetDbValueDef($rsnew, $this->section_03_title->CurrentValue, NULL, $this->section_03_title->ReadOnly);

			// section_03_title_ar
			$this->section_03_title_ar->SetDbValueDef($rsnew, $this->section_03_title_ar->CurrentValue, NULL, $this->section_03_title_ar->ReadOnly);

			// section_03_summary
			$this->section_03_summary->SetDbValueDef($rsnew, $this->section_03_summary->CurrentValue, NULL, $this->section_03_summary->ReadOnly);

			// section_03_summary_ar
			$this->section_03_summary_ar->SetDbValueDef($rsnew, $this->section_03_summary_ar->CurrentValue, NULL, $this->section_03_summary_ar->ReadOnly);

			// section_03_icon
			$this->section_03_icon->SetDbValueDef($rsnew, $this->section_03_icon->CurrentValue, NULL, $this->section_03_icon->ReadOnly);

			// section_04_title
			$this->section_04_title->SetDbValueDef($rsnew, $this->section_04_title->CurrentValue, NULL, $this->section_04_title->ReadOnly);

			// section_04_title_ar
			$this->section_04_title_ar->SetDbValueDef($rsnew, $this->section_04_title_ar->CurrentValue, NULL, $this->section_04_title_ar->ReadOnly);

			// section_04_summary
			$this->section_04_summary->SetDbValueDef($rsnew, $this->section_04_summary->CurrentValue, NULL, $this->section_04_summary->ReadOnly);

			// section_04_summary_ar
			$this->section_04_summary_ar->SetDbValueDef($rsnew, $this->section_04_summary_ar->CurrentValue, NULL, $this->section_04_summary_ar->ReadOnly);

			// section_04_icon
			$this->section_04_icon->SetDbValueDef($rsnew, $this->section_04_icon->CurrentValue, NULL, $this->section_04_icon->ReadOnly);
			if ($this->sliderImage->Visible && !$this->sliderImage->Upload->KeepFile) {
				...
				if (!ew_Empty($this->sliderImage->Upload->FileName)) {
					...
					$this->sliderImage->SetDbValueDef($rsnew, $this->sliderImage->Upload->FileName, NULL, $this->sliderImage->ReadOnly);
				}
			}
			if ($this->sliderImage_ar->Visible && !$this->sliderImage_ar->Upload->KeepFile) {
				...
				if (!ew_Empty($this->sliderImage_ar->Upload->FileName)) {
					...
					$this->sliderImage_ar->SetDbValueDef($rsnew, $this->sliderImage_ar->Upload->FileName, NULL, $this->sliderImage_ar->ReadOnly);
				}
			}
...
// Create page object
if (!isset($campaign_aboutus_edit)) $campaign_aboutus_edit = new ccampaign_aboutus_edit();

// Page init
$campaign_aboutus_edit->Page_Init();

// Page main
$campaign_aboutus_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$campaign_aboutus_edit->Page_Render();
?>
...
var CurrentForm = fcampaign_aboutusedit = new ew_Form("fcampaign_aboutusedit", "edit");

// Validate form
fcampaign_aboutusedit.Validate = function() {
...
fcampaign_aboutusedit.Form_CustomValidate = 
...
fcampaign_aboutusedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fcampaign_aboutusedit.MultiPage = new ew_MultiPage("fcampaign_aboutusedit");
...
<?php $campaign_aboutus_edit->ShowPageHeader(); ?>
<?php
$campaign_aboutus_edit->ShowMessage();
?>
<form name="fcampaign_aboutusedit" id="fcampaign_aboutusedit" class="<?php echo $campaign_aboutus_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($campaign_aboutus_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $campaign_aboutus_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="campaign_aboutus">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($campaign_aboutus_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="campaign_aboutus_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $campaign_aboutus_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $campaign_aboutus_edit->MultiPages->TabStyle("1") ?>><a href="#tab_campaign_aboutus1" data-toggle="tab"><?php echo $campaign_aboutus->PageCaption(1) ?></a></li>
		<li<?php echo $campaign_aboutus_edit->MultiPages->TabStyle("2") ?>><a href="#tab_campaign_aboutus2" data-toggle="tab"><?php echo $campaign_aboutus->PageCaption(2) ?></a></li>
		<li<?php echo $campaign_aboutus_edit->MultiPages->TabStyle("3") ?>><a href="#tab_campaign_aboutus3" data-toggle="tab"><?php echo $campaign_aboutus->PageCaption(3) ?></a></li>
		<li<?php echo $campaign_aboutus_edit->MultiPages->TabStyle("4") ?>><a href="#tab_campaign_aboutus4" data-toggle="tab"><?php echo $campaign_aboutus->PageCaption(4) ?></a></li>
		<li<?php echo $campaign_aboutus_edit->MultiPages->TabStyle("5") ?>><a href="#tab_campaign_aboutus5" data-toggle="tab"><?php echo $campaign_aboutus->PageCaption(5) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $campaign_aboutus_edit->MultiPages->PageStyle("1") ?>" id="tab_campaign_aboutus1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($campaign_aboutus->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_campaign_aboutus_id" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->id->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->id->CellAttributes() ?>>
<span id="el_campaign_aboutus_id">
<span<?php echo $campaign_aboutus->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $campaign_aboutus->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="campaign_aboutus" data-field="x_id" data-page="1" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($campaign_aboutus->id->CurrentValue) ?>">
<?php echo $campaign_aboutus->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($campaign_aboutus->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_campaign_aboutus_title" for="x_title" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->title->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->title->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->title_ar->Visible) { // title_ar ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_campaign_aboutus_title_ar" for="x_title_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->title_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->title_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->sliderImage->Visible) { // sliderImage ?>
	<div id="r_sliderImage" class="form-group">
		<label id="elh_campaign_aboutus_sliderImage" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->sliderImage->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->sliderImage->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_sliderImage"] == "0") { ?>
<input type="hidden" name="fa_x_sliderImage" id= "fa_x_sliderImage" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_sliderImage" id= "fa_x_sliderImage" value="1">
<?php } ?>
...
<?php if ($campaign_aboutus->sliderImage_ar->Visible) { // sliderImage_ar ?>
	<div id="r_sliderImage_ar" class="form-group">
		<label id="elh_campaign_aboutus_sliderImage_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->sliderImage_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->sliderImage_ar->CellAttributes() ?>>
...
<?php if (@$_POST["fa_x_sliderImage_ar"] == "0") { ?>
<input type="hidden" name="fa_x_sliderImage_ar" id= "fa_x_sliderImage_ar" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_sliderImage_ar" id= "fa_x_sliderImage_ar" value="1">
<?php } ?>
...
<?php if ($campaign_aboutus->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_campaign_aboutus_description" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->description->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcampaign_aboutusedit", "x_description", 35, 4, <?php echo ($campaign_aboutus->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($campaign_aboutus->description_ar->Visible) { // description_ar ?>
	<div id="r_description_ar" class="form-group">
		<label id="elh_campaign_aboutus_description_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->description_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->description_ar->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcampaign_aboutusedit", "x_description_ar", 35, 4, <?php echo ($campaign_aboutus->description_ar->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $campaign_aboutus_edit->MultiPages->PageStyle("2") ?>" id="tab_campaign_aboutus2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($campaign_aboutus->section_01_title->Visible) { // section_01_title ?>
	<div id="r_section_01_title" class="form-group">
		<label id="elh_campaign_aboutus_section_01_title" for="x_section_01_title" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_01_title->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_01_title->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_01_title_ar->Visible) { // section_01_title_ar ?>
	<div id="r_section_01_title_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_01_title_ar" for="x_section_01_title_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_01_title_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_01_title_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_01_summary->Visible) { // section_01_summary ?>
	<div id="r_section_01_summary" class="form-group">
		<label id="elh_campaign_aboutus_section_01_summary" for="x_section_01_summary" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_01_summary->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_01_summary->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_01_summary_ar->Visible) { // section_01_summary_ar ?>
	<div id="r_section_01_summary_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_01_summary_ar" for="x_section_01_summary_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_01_summary_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_01_summary_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_01_icon->Visible) { // section_01_icon ?>
	<div id="r_section_01_icon" class="form-group">
		<label id="elh_campaign_aboutus_section_01_icon" for="x_section_01_icon" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_01_icon->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_01_icon->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $campaign_aboutus_edit->MultiPages->PageStyle("3") ?>" id="tab_campaign_aboutus3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($campaign_aboutus->section_02_title->Visible) { // section_02_title ?>
	<div id="r_section_02_title" class="form-group">
		<label id="elh_campaign_aboutus_section_02_title" for="x_section_02_title" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_02_title->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_02_title->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_02_title_ar->Visible) { // section_02_title_ar ?>
	<div id="r_section_02_title_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_02_title_ar" for="x_section_02_title_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_02_title_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_02_title_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_02_summary->Visible) { // section_02_summary ?>
	<div id="r_section_02_summary" class="form-group">
		<label id="elh_campaign_aboutus_section_02_summary" for="x_section_02_summary" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_02_summary->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_02_summary->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_02_summary_ar->Visible) { // section_02_summary_ar ?>
	<div id="r_section_02_summary_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_02_summary_ar" for="x_section_02_summary_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_02_summary_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_02_summary_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_02_icon->Visible) { // section_02_icon ?>
	<div id="r_section_02_icon" class="form-group">
		<label id="elh_campaign_aboutus_section_02_icon" for="x_section_02_icon" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_02_icon->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_02_icon->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $campaign_aboutus_edit->MultiPages->PageStyle("4") ?>" id="tab_campaign_aboutus4"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($campaign_aboutus->section_03_title->Visible) { // section_03_title ?>
	<div id="r_section_03_title" class="form-group">
		<label id="elh_campaign_aboutus_section_03_title" for="x_section_03_title" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_03_title->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_03_title->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_03_title_ar->Visible) { // section_03_title_ar ?>
	<div id="r_section_03_title_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_03_title_ar" for="x_section_03_title_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_03_title_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_03_title_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_03_summary->Visible) { // section_03_summary ?>
	<div id="r_section_03_summary" class="form-group">
		<label id="elh_campaign_aboutus_section_03_summary" for="x_section_03_summary" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_03_summary->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_03_summary->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_03_summary_ar->Visible) { // section_03_summary_ar ?>
	<div id="r_section_03_summary_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_03_summary_ar" for="x_section_03_summary_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_03_summary_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_03_summary_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_03_icon->Visible) { // section_03_icon ?>
	<div id="r_section_03_icon" class="form-group">
		<label id="elh_campaign_aboutus_section_03_icon" for="x_section_03_icon" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_03_icon->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_03_icon->CellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $campaign_aboutus_edit->MultiPages->PageStyle("5") ?>" id="tab_campaign_aboutus5"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($campaign_aboutus->section_04_title->Visible) { // section_04_title ?>
	<div id="r_section_04_title" class="form-group">
		<label id="elh_campaign_aboutus_section_04_title" for="x_section_04_title" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_04_title->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_04_title->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_04_title_ar->Visible) { // section_04_title_ar ?>
	<div id="r_section_04_title_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_04_title_ar" for="x_section_04_title_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_04_title_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_04_title_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_04_summary->Visible) { // section_04_summary ?>
	<div id="r_section_04_summary" class="form-group">
		<label id="elh_campaign_aboutus_section_04_summary" for="x_section_04_summary" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_04_summary->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_04_summary->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_04_summary_ar->Visible) { // section_04_summary_ar ?>
	<div id="r_section_04_summary_ar" class="form-group">
		<label id="elh_campaign_aboutus_section_04_summary_ar" for="x_section_04_summary_ar" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_04_summary_ar->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_04_summary_ar->CellAttributes() ?>>
...
<?php if ($campaign_aboutus->section_04_icon->Visible) { // section_04_icon ?>
	<div id="r_section_04_icon" class="form-group">
		<label id="elh_campaign_aboutus_section_04_icon" for="x_section_04_icon" class="<?php echo $campaign_aboutus_edit->LeftColumnClass ?>"><?php echo $campaign_aboutus->section_04_icon->FldCaption() ?></label>
		<div class="<?php echo $campaign_aboutus_edit->RightColumnClass ?>"><div<?php echo $campaign_aboutus->section_04_icon->CellAttributes() ?>>
...
<?php if (!$campaign_aboutus_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $campaign_aboutus_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $campaign_aboutus_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcampaign_aboutusedit.Init();
</script>
<?php
$campaign_aboutus_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$campaign_aboutus_edit->Page_Terminate();
?>
