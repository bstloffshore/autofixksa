...
<?php if ($campaign_report->message->Visible) { // message ?>
	<?php if ($campaign_report->SortUrl($campaign_report->message) == "") { ?>
		<th data-name="message" class="<?php echo $campaign_report->message->HeaderCellClass() ?>"><div id="elh_campaign_report_message" class="campaign_report_message><div class="ewTableHeaderCaption"><?php echo $campaign_report->message->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="message" class="<?php echo $campaign_report->message->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $campaign_report->SortUrl($campaign_report->message) ?>',1);"><div id="elh_campaign_report_message" class="campaign_report_message">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $campaign_report->message->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($campaign_report->message->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($campaign_report->message->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<span id="el<?php echo $campaign_report_list->RowCnt ?>_campaign_report_message" class="campaign_report_message">
<span<?php echo $campaign_report->message->ViewAttributes() ?>>
<?php echo $campaign_report->message->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($campaign_report->dateCreated->Visible) { // dateCreated ?>
