...
$campaign_report_view = NULL; // Initialize page object first

class ccampaign_report_view extends ccampaign_report {
	...
	// Page object name
	var $PageObjName = 'campaign_report_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["campaignReportID"] <> "") {
			$this->RecKey["campaignReportID"] = $_GET["campaignReportID"];
			$KeyUrl .= "&amp;campaignReportID=" . urlencode($this->RecKey["campaignReportID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["campaignReportID"] <> "") {
			...
			$gsExportFile .= $_GET["campaignReportID"];
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["campaignReportID"] <> "") {
				...
				$this->RecKey["campaignReportID"] = $this->campaignReportID->QueryStringValue;
			} elseif (@$_POST["campaignReportID"] <> "") {
				$this->campaignReportID->setFormValue($_POST["campaignReportID"]);
				$this->RecKey["campaignReportID"] = $this->campaignReportID->FormValue;
			} else {
				$sReturnUrl = "campaign_reportlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "campaign_reportlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "campaign_reportlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($campaign_report_view)) $campaign_report_view = new ccampaign_report_view();

// Page init
$campaign_report_view->Page_Init();

// Page main
$campaign_report_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$campaign_report_view->Page_Render();
?>
...
var CurrentForm = fcampaign_reportview = new ew_Form("fcampaign_reportview", "view");

// Form_CustomValidate event
fcampaign_reportview.Form_CustomValidate = 
...
fcampaign_reportview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcampaign_reportview.Lists["x_campaignID"] = {"LinkField":"x_campaignID","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"campaign_master"};
fcampaign_reportview.Lists["x_campaignID"].Data = "<?php echo $campaign_report_view->campaignID->LookupFilterQuery(FALSE, "view") ?>";
fcampaign_reportview.Lists["x_campaignLanguage"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcampaign_reportview.Lists["x_campaignLanguage"].Options = <?php echo json_encode($campaign_report_view->campaignLanguage->Options()) ?>;
fcampaign_reportview.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcampaign_reportview.Lists["x_status"].Options = <?php echo json_encode($campaign_report_view->status->Options()) ?>;
...
<?php if ($campaign_report->Export == "") { ?>
<div class="ewToolbar">
<?php $campaign_report_view->ExportOptions->Render("body") ?>
<?php
	foreach ($campaign_report_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $campaign_report_view->ShowPageHeader(); ?>
<?php
$campaign_report_view->ShowMessage();
?>
<form name="fcampaign_reportview" id="fcampaign_reportview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($campaign_report_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $campaign_report_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="campaign_report">
<input type="hidden" name="modal" value="<?php echo intval($campaign_report_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($campaign_report->campaignReportID->Visible) { // campaignReportID ?>
	<tr id="r_campaignReportID">
		<td class="col-sm-2"><span id="elh_campaign_report_campaignReportID"><?php echo $campaign_report->campaignReportID->FldCaption() ?></span></td>
...
<?php echo $campaign_report->campaignReportID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->campaignID->Visible) { // campaignID ?>
	<tr id="r_campaignID">
		<td class="col-sm-2"><span id="elh_campaign_report_campaignID"><?php echo $campaign_report->campaignID->FldCaption() ?></span></td>
...
<?php echo $campaign_report->campaignID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->campaignLanguage->Visible) { // campaignLanguage ?>
	<tr id="r_campaignLanguage">
		<td class="col-sm-2"><span id="elh_campaign_report_campaignLanguage"><?php echo $campaign_report->campaignLanguage->FldCaption() ?></span></td>
...
<?php echo $campaign_report->campaignLanguage->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->fullName->Visible) { // fullName ?>
	<tr id="r_fullName">
		<td class="col-sm-2"><span id="elh_campaign_report_fullName"><?php echo $campaign_report->fullName->FldCaption() ?></span></td>
...
<?php echo $campaign_report->fullName->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_campaign_report__email"><?php echo $campaign_report->_email->FldCaption() ?></span></td>
...
<?php echo $campaign_report->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td class="col-sm-2"><span id="elh_campaign_report_phone"><?php echo $campaign_report->phone->FldCaption() ?></span></td>
...
<?php echo $campaign_report->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->message->Visible) { // message ?>
	<tr id="r_message">
		<td class="col-sm-2"><span id="elh_campaign_report_message"><?php echo $campaign_report->message->FldCaption() ?></span></td>
		<td data-name="message"<?php echo $campaign_report->message->CellAttributes() ?>>
<span id="el_campaign_report_message">
<span<?php echo $campaign_report->message->ViewAttributes() ?>>
<?php echo $campaign_report->message->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->dateCreated->Visible) { // dateCreated ?>
	<tr id="r_dateCreated">
		<td class="col-sm-2"><span id="elh_campaign_report_dateCreated"><?php echo $campaign_report->dateCreated->FldCaption() ?></span></td>
...
<?php echo $campaign_report->dateCreated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($campaign_report->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_campaign_report_status"><?php echo $campaign_report->status->FldCaption() ?></span></td>
...
<?php echo $campaign_report->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($campaign_report->Export == "") { ?>
<script type="text/javascript">
fcampaign_reportview.Init();
</script>
<?php } ?>
<?php
$campaign_report_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($campaign_report->Export == "") { ?>
...
<?php
$campaign_report_view->Page_Terminate();
?>
