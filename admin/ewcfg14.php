...
define("EW_PROJECT_NAME", "Autofix", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{8281128E-C7BB-40DA-A1AE-8695DB7283AC}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'gPJ09dDrU6E8b1JJ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Autofix.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "staging.techneek.in", "port" => 3306, "user" => "techneek_develop", "pass" => "K?SI#hV(\$Tdb", "db" => "tech_autofix", "qs" => "`", "qe" => "`");
include_once "../masterconfig.php";
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => $dbhost, "port" => 3306, "user" => $dbuser, "pass" => $dbpass, "db" => $dbdatabase, "qs" => "`", "qe" => "`");
