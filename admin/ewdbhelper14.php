...
if (!function_exists('DbHelper')) {
	...
	function &DbHelper($dbid = "", $langfolder = "", $langid = "", $info = NULL) {
		...
		$dbclass = "ctech_autofix_db";
		$dbhelper = new $dbclass($langfolder, $langid, $info);
		return $dbhelper;
	}
}

class ctech_autofix_db extends cDbHelper {

	// Database connection info
	var $Host = 'staging.techneek.in';
	var $Port = 3306;
	var $Username = 'techneek_develop';
	var $Password = 'K?SI#hV($Tdb';
	var $DbName = 'tech_autofix';
