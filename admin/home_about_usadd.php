...
$home_about_us_add = NULL; // Initialize page object first

class chome_about_us_add extends chome_about_us {
	...
	// Page object name
	var $PageObjName = 'home_about_us_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "home_about_usview.php")
	...
	function LoadDefaultValues() {
		...
		$this->image_01->Upload->DbValue = NULL;
		$this->image_01->OldValue = $this->image_01->Upload->DbValue;
		$this->image_01->CurrentValue = NULL; // Clear file related field
		$this->image_02->Upload->DbValue = NULL;
		$this->image_02->OldValue = $this->image_02->Upload->DbValue;
		$this->image_02->CurrentValue = NULL; // Clear file related field
		$this->image_03->Upload->DbValue = NULL;
		$this->image_03->OldValue = $this->image_03->Upload->DbValue;
		$this->image_03->CurrentValue = NULL; // Clear file related field
	}
	...
	function NewRow() {
		...
		$row['image_01'] = $this->image_01->Upload->DbValue;
		$row['image_02'] = $this->image_02->Upload->DbValue;
		$row['image_03'] = $this->image_03->Upload->DbValue;
		return $row;
	}
	...
	function RenderRow() {
		...
		$this->image_03->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->image_01);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->image_02);
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->image_03);
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->image_01->Visible && !$this->image_01->Upload->KeepFile) {
			$this->image_01->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->image_02->Visible && !$this->image_02->Upload->KeepFile) {
			$this->image_02->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->image_03->Visible && !$this->image_03->Upload->KeepFile) {
			$this->image_03->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->image_01->Visible && !$this->image_01->Upload->KeepFile) {
			...
			if (!ew_Empty($this->image_01->Upload->FileName)) {
				...
				$this->image_01->SetDbValueDef($rsnew, $this->image_01->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->image_02->Visible && !$this->image_02->Upload->KeepFile) {
			$this->image_02->UploadPath = 'uploads/pages';
			...
			if (!ew_Empty($this->image_02->Upload->FileName)) {
				...
				$this->image_02->SetDbValueDef($rsnew, $this->image_02->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->image_03->Visible && !$this->image_03->Upload->KeepFile) {
			$this->image_03->UploadPath = 'uploads/pages';
			...
			if (!ew_Empty($this->image_03->Upload->FileName)) {
				...
				$this->image_03->SetDbValueDef($rsnew, $this->image_03->Upload->FileName, NULL, FALSE);
			}
		}
...
// Create page object
if (!isset($home_about_us_add)) $home_about_us_add = new chome_about_us_add();

// Page init
$home_about_us_add->Page_Init();

// Page main
$home_about_us_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$home_about_us_add->Page_Render();
?>
...
var CurrentForm = fhome_about_usadd = new ew_Form("fhome_about_usadd", "add");

// Validate form
fhome_about_usadd.Validate = function() {
...
fhome_about_usadd.Form_CustomValidate = 
...
fhome_about_usadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fhome_about_usadd.MultiPage = new ew_MultiPage("fhome_about_usadd");
...
<?php $home_about_us_add->ShowPageHeader(); ?>
<?php
$home_about_us_add->ShowMessage();
?>
<form name="fhome_about_usadd" id="fhome_about_usadd" class="<?php echo $home_about_us_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($home_about_us_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $home_about_us_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="home_about_us">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($home_about_us_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="home_about_us_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $home_about_us_add->MultiPages->NavStyle() ?>">
		<li<?php echo $home_about_us_add->MultiPages->TabStyle("1") ?>><a href="#tab_home_about_us1" data-toggle="tab"><?php echo $home_about_us->PageCaption(1) ?></a></li>
		<li<?php echo $home_about_us_add->MultiPages->TabStyle("2") ?>><a href="#tab_home_about_us2" data-toggle="tab"><?php echo $home_about_us->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $home_about_us_add->MultiPages->PageStyle("1") ?>" id="tab_home_about_us1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($home_about_us->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_home_about_us_title" for="x_title" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->title->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->title->CellAttributes() ?>>
...
<?php if ($home_about_us->title_ar->Visible) { // title_ar ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_home_about_us_title_ar" for="x_title_ar" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->title_ar->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->title_ar->CellAttributes() ?>>
...
<?php if ($home_about_us->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_home_about_us_description" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->description->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->description->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fhome_about_usadd", "x_description", 35, 4, <?php echo ($home_about_us->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($home_about_us->description_ar->Visible) { // description_ar ?>
	<div id="r_description_ar" class="form-group">
		<label id="elh_home_about_us_description_ar" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->description_ar->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->description_ar->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fhome_about_usadd", "x_description_ar", 35, 4, <?php echo ($home_about_us->description_ar->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $home_about_us_add->MultiPages->PageStyle("2") ?>" id="tab_home_about_us2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($home_about_us->image_01->Visible) { // image_01 ?>
	<div id="r_image_01" class="form-group">
		<label id="elh_home_about_us_image_01" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->image_01->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->image_01->CellAttributes() ?>>
...
<?php if ($home_about_us->image_02->Visible) { // image_02 ?>
	<div id="r_image_02" class="form-group">
		<label id="elh_home_about_us_image_02" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->image_02->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->image_02->CellAttributes() ?>>
...
<?php if ($home_about_us->image_03->Visible) { // image_03 ?>
	<div id="r_image_03" class="form-group">
		<label id="elh_home_about_us_image_03" class="<?php echo $home_about_us_add->LeftColumnClass ?>"><?php echo $home_about_us->image_03->FldCaption() ?></label>
		<div class="<?php echo $home_about_us_add->RightColumnClass ?>"><div<?php echo $home_about_us->image_03->CellAttributes() ?>>
...
<?php if (!$home_about_us_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $home_about_us_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $home_about_us_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fhome_about_usadd.Init();
</script>
<?php
$home_about_us_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$home_about_us_add->Page_Terminate();
?>
