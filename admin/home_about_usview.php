...
$home_about_us_view = NULL; // Initialize page object first

class chome_about_us_view extends chome_about_us {
	...
	// Page object name
	var $PageObjName = 'home_about_us_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "home_about_uslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "home_about_uslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "home_about_uslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($home_about_us_view)) $home_about_us_view = new chome_about_us_view();

// Page init
$home_about_us_view->Page_Init();

// Page main
$home_about_us_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$home_about_us_view->Page_Render();
?>
...
var CurrentForm = fhome_about_usview = new ew_Form("fhome_about_usview", "view");

// Form_CustomValidate event
fhome_about_usview.Form_CustomValidate = 
...
fhome_about_usview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fhome_about_usview.MultiPage = new ew_MultiPage("fhome_about_usview");
...
<?php if ($home_about_us->Export == "") { ?>
<div class="ewToolbar">
<?php $home_about_us_view->ExportOptions->Render("body") ?>
<?php
	foreach ($home_about_us_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $home_about_us_view->ShowPageHeader(); ?>
<?php
$home_about_us_view->ShowMessage();
?>
<form name="fhome_about_usview" id="fhome_about_usview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($home_about_us_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $home_about_us_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="home_about_us">
<input type="hidden" name="modal" value="<?php echo intval($home_about_us_view->IsModal) ?>">
<?php if ($home_about_us->Export == "") { ?>
<div class="ewMultiPage">
<div class="nav-tabs-custom" id="home_about_us_view">
	<ul class="nav<?php echo $home_about_us_view->MultiPages->NavStyle() ?>">
		<li<?php echo $home_about_us_view->MultiPages->TabStyle("1") ?>><a href="#tab_home_about_us1" data-toggle="tab"><?php echo $home_about_us->PageCaption(1) ?></a></li>
		<li<?php echo $home_about_us_view->MultiPages->TabStyle("2") ?>><a href="#tab_home_about_us2" data-toggle="tab"><?php echo $home_about_us->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content">
<?php } ?>
<?php if ($home_about_us->Export == "") { ?>
		<div class="tab-pane<?php echo $home_about_us_view->MultiPages->PageStyle("1") ?>" id="tab_home_about_us1">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($home_about_us->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_home_about_us_id"><?php echo $home_about_us->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $home_about_us->id->CellAttributes() ?>>
<span id="el_home_about_us_id" data-page="1">
<span<?php echo $home_about_us->id->ViewAttributes() ?>>
<?php echo $home_about_us->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($home_about_us->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_home_about_us_title"><?php echo $home_about_us->title->FldCaption() ?></span></td>
		<td data-name="title"<?php echo $home_about_us->title->CellAttributes() ?>>
<span id="el_home_about_us_title" data-page="1">
<span<?php echo $home_about_us->title->ViewAttributes() ?>>
<?php echo $home_about_us->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($home_about_us->title_ar->Visible) { // title_ar ?>
	<tr id="r_title_ar">
		<td class="col-sm-2"><span id="elh_home_about_us_title_ar"><?php echo $home_about_us->title_ar->FldCaption() ?></span></td>
		<td data-name="title_ar"<?php echo $home_about_us->title_ar->CellAttributes() ?>>
<span id="el_home_about_us_title_ar" data-page="1">
<span<?php echo $home_about_us->title_ar->ViewAttributes() ?>>
<?php echo $home_about_us->title_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($home_about_us->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_home_about_us_description"><?php echo $home_about_us->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $home_about_us->description->CellAttributes() ?>>
<span id="el_home_about_us_description" data-page="1">
<span<?php echo $home_about_us->description->ViewAttributes() ?>>
<?php echo $home_about_us->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($home_about_us->description_ar->Visible) { // description_ar ?>
	<tr id="r_description_ar">
		<td class="col-sm-2"><span id="elh_home_about_us_description_ar"><?php echo $home_about_us->description_ar->FldCaption() ?></span></td>
		<td data-name="description_ar"<?php echo $home_about_us->description_ar->CellAttributes() ?>>
<span id="el_home_about_us_description_ar" data-page="1">
<span<?php echo $home_about_us->description_ar->ViewAttributes() ?>>
<?php echo $home_about_us->description_ar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($home_about_us->Export == "") { ?>
		<div class="tab-pane<?php echo $home_about_us_view->MultiPages->PageStyle("2") ?>" id="tab_home_about_us2">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($home_about_us->image_01->Visible) { // image_01 ?>
	<tr id="r_image_01">
		<td class="col-sm-2"><span id="elh_home_about_us_image_01"><?php echo $home_about_us->image_01->FldCaption() ?></span></td>
		<td data-name="image_01"<?php echo $home_about_us->image_01->CellAttributes() ?>>
<span id="el_home_about_us_image_01" data-page="2">
<span>
<?php echo ew_GetFileViewTag($home_about_us->image_01, $home_about_us->image_01->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($home_about_us->image_02->Visible) { // image_02 ?>
	<tr id="r_image_02">
		<td class="col-sm-2"><span id="elh_home_about_us_image_02"><?php echo $home_about_us->image_02->FldCaption() ?></span></td>
		<td data-name="image_02"<?php echo $home_about_us->image_02->CellAttributes() ?>>
<span id="el_home_about_us_image_02" data-page="2">
<span>
<?php echo ew_GetFileViewTag($home_about_us->image_02, $home_about_us->image_02->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($home_about_us->image_03->Visible) { // image_03 ?>
	<tr id="r_image_03">
		<td class="col-sm-2"><span id="elh_home_about_us_image_03"><?php echo $home_about_us->image_03->FldCaption() ?></span></td>
		<td data-name="image_03"<?php echo $home_about_us->image_03->CellAttributes() ?>>
<span id="el_home_about_us_image_03" data-page="2">
<span>
<?php echo ew_GetFileViewTag($home_about_us->image_03, $home_about_us->image_03->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($home_about_us->Export == "") { ?>
<script type="text/javascript">
fhome_about_usview.Init();
</script>
<?php } ?>
<?php
$home_about_us_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($home_about_us->Export == "") { ?>
...
<?php
$home_about_us_view->Page_Terminate();
?>
