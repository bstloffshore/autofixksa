...
class cdefault {
	...
	function Page_Main() {
		...
		$this->Page_Terminate("about_uslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'cms_users'))
			$this->Page_Terminate("cms_userslist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'web_branches'))
			$this->Page_Terminate("web_brancheslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'clients'))
			$this->Page_Terminate("clientslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'home_about_us'))
			$this->Page_Terminate("home_about_uslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'inb_estimate'))
			$this->Page_Terminate("inb_estimatelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'our_process'))
			$this->Page_Terminate("our_processlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'our_values'))
		...
		if ($Security->AllowList(CurrentProjectID() . 'translations'))
			$this->Page_Terminate("translationslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'campaign_aboutus'))
			$this->Page_Terminate("campaign_aboutuslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'campaign_master'))
			$this->Page_Terminate("campaign_masterlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'campaign_report'))
			$this->Page_Terminate("campaign_reportlist.php");
