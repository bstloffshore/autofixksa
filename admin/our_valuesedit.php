...
class cour_values_edit extends cour_values {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_valueID")) {
				$this->valueID->setFormValue($objForm->GetValue("x_valueID"));
			}
		} else {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->valueID->FldIsDetailKey)
			$this->valueID->setFormValue($objForm->GetValue("x_valueID"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->valueID->CurrentValue = $this->valueID->FormValue;
	...
	function RenderRow() {
		...
		$this->active->ViewCustomAttributes = "";
			...
			// valueID
			$this->valueID->EditAttrs["class"] = "form-control";
			$this->valueID->EditCustomAttributes = "";
			$this->valueID->EditValue = $this->valueID->CurrentValue;
			$this->valueID->ViewCustomAttributes = "";
...
four_valuesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
four_valuesedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
four_valuesedit.Lists["x_active"].Options = <?php echo json_encode($our_values_edit->active->Options()) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($our_values_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($our_values->valueID->Visible) { // valueID ?>
	<div id="r_valueID" class="form-group">
		<label id="elh_our_values_valueID" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->valueID->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->valueID->CellAttributes() ?>>
<span id="el_our_values_valueID">
<span<?php echo $our_values->valueID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $our_values->valueID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="our_values" data-field="x_valueID" name="x_valueID" id="x_valueID" value="<?php echo ew_HtmlEncode($our_values->valueID->CurrentValue) ?>">
<?php echo $our_values->valueID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($our_values->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_our_values_title" for="x_title" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->title->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->title->CellAttributes() ?>>
...
<?php if ($our_values->title_ar->Visible) { // title_ar ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_our_values_title_ar" for="x_title_ar" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->title_ar->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->title_ar->CellAttributes() ?>>
...
<?php if ($our_values->class->Visible) { // class ?>
	<div id="r_class" class="form-group">
		<label id="elh_our_values_class" for="x_class" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->class->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->class->CellAttributes() ?>>
...
<?php if ($our_values->summary->Visible) { // summary ?>
	<div id="r_summary" class="form-group">
		<label id="elh_our_values_summary" for="x_summary" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->summary->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->summary->CellAttributes() ?>>
...
<?php if ($our_values->summary_ar->Visible) { // summary_ar ?>
	<div id="r_summary_ar" class="form-group">
		<label id="elh_our_values_summary_ar" for="x_summary_ar" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->summary_ar->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->summary_ar->CellAttributes() ?>>
...
<?php if ($our_values->so->Visible) { // so ?>
	<div id="r_so" class="form-group">
		<label id="elh_our_values_so" for="x_so" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->so->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->so->CellAttributes() ?>>
...
<?php if ($our_values->active->Visible) { // active ?>
	<div id="r_active" class="form-group">
		<label id="elh_our_values_active" for="x_active" class="<?php echo $our_values_edit->LeftColumnClass ?>"><?php echo $our_values->active->FldCaption() ?></label>
		<div class="<?php echo $our_values_edit->RightColumnClass ?>"><div<?php echo $our_values->active->CellAttributes() ?>>
...
<?php if (!$our_values_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $our_values_edit->OffsetColumnClass ?>"><!-- buttons offset -->
