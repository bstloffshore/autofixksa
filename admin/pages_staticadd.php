...
<?php if ($pages_static->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_pages_static_title" for="x_title" class="<?php echo $pages_static_add->LeftColumnClass ?>"><?php echo $pages_static->title->FldCaption() ?></label>
		<div class="<?php echo $pages_static_add->RightColumnClass ?>"><div<?php echo $pages_static->title->CellAttributes() ?>>
...
<?php if ($pages_static->title_ar->Visible) { // title_ar ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_pages_static_title_ar" for="x_title_ar" class="<?php echo $pages_static_add->LeftColumnClass ?>"><?php echo $pages_static->title_ar->FldCaption() ?></label>
		<div class="<?php echo $pages_static_add->RightColumnClass ?>"><div<?php echo $pages_static->title_ar->CellAttributes() ?>>
...
<?php if ($pages_static->summary_ar->Visible) { // summary_ar ?>
	<div id="r_summary_ar" class="form-group">
		<label id="elh_pages_static_summary_ar" for="x_summary_ar" class="<?php echo $pages_static_add->LeftColumnClass ?>"><?php echo $pages_static->summary_ar->FldCaption() ?></label>
		<div class="<?php echo $pages_static_add->RightColumnClass ?>"><div<?php echo $pages_static->summary_ar->CellAttributes() ?>>
...
<?php if ($pages_static->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_pages_static_image" class="<?php echo $pages_static_add->LeftColumnClass ?>"><?php echo $pages_static->image->FldCaption() ?></label>
