...
<?php if ($pages_static->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_pages_static_id" class="<?php echo $pages_static_edit->LeftColumnClass ?>"><?php echo $pages_static->id->FldCaption() ?></label>
		<div class="<?php echo $pages_static_edit->RightColumnClass ?>"><div<?php echo $pages_static->id->CellAttributes() ?>>
<span id="el_pages_static_id">
<span<?php echo $pages_static->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $pages_static->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="pages_static" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($pages_static->id->CurrentValue) ?>">
<?php echo $pages_static->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pages_static->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_pages_static_title" for="x_title" class="<?php echo $pages_static_edit->LeftColumnClass ?>"><?php echo $pages_static->title->FldCaption() ?></label>
		<div class="<?php echo $pages_static_edit->RightColumnClass ?>"><div<?php echo $pages_static->title->CellAttributes() ?>>
<span id="el_pages_static_title">
<input type="text" data-table="pages_static" data-field="x_title" name="x_title" id="x_title" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($pages_static->title->getPlaceHolder()) ?>" value="<?php echo $pages_static->title->EditValue ?>"<?php echo $pages_static->title->EditAttributes() ?>>
</span>
<?php echo $pages_static->title->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pages_static->title_ar->Visible) { // title_ar ?>
	<div id="r_title_ar" class="form-group">
		<label id="elh_pages_static_title_ar" for="x_title_ar" class="<?php echo $pages_static_edit->LeftColumnClass ?>"><?php echo $pages_static->title_ar->FldCaption() ?></label>
		<div class="<?php echo $pages_static_edit->RightColumnClass ?>"><div<?php echo $pages_static->title_ar->CellAttributes() ?>>
<span id="el_pages_static_title_ar">
<input type="text" data-table="pages_static" data-field="x_title_ar" name="x_title_ar" id="x_title_ar" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($pages_static->title_ar->getPlaceHolder()) ?>" value="<?php echo $pages_static->title_ar->EditValue ?>"<?php echo $pages_static->title_ar->EditAttributes() ?>>
</span>
<?php echo $pages_static->title_ar->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<input type="text" data-table="pages_static" data-field="x_summary" name="x_summary" id="x_summary" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($pages_static->summary->getPlaceHolder()) ?>" value="<?php echo $pages_static->summary->EditValue ?>"<?php echo $pages_static->summary->EditAttributes() ?>>
</span>
...
<?php if ($pages_static->summary_ar->Visible) { // summary_ar ?>
	<div id="r_summary_ar" class="form-group">
		<label id="elh_pages_static_summary_ar" for="x_summary_ar" class="<?php echo $pages_static_edit->LeftColumnClass ?>"><?php echo $pages_static->summary_ar->FldCaption() ?></label>
		<div class="<?php echo $pages_static_edit->RightColumnClass ?>"><div<?php echo $pages_static->summary_ar->CellAttributes() ?>>
<span id="el_pages_static_summary_ar">
<input type="text" data-table="pages_static" data-field="x_summary_ar" name="x_summary_ar" id="x_summary_ar" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($pages_static->summary_ar->getPlaceHolder()) ?>" value="<?php echo $pages_static->summary_ar->EditValue ?>"<?php echo $pages_static->summary_ar->EditAttributes() ?>>
</span>
<?php echo $pages_static->summary_ar->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pages_static->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_pages_static_image" class="<?php echo $pages_static_edit->LeftColumnClass ?>"><?php echo $pages_static->image->FldCaption() ?></label>
...
<div id="fd_x_image">
<span title="<?php echo $pages_static->image->FldTitle() ? $pages_static->image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($pages_static->image->ReadOnly || $pages_static->image->Disabled) echo " hide"; ?>" data-trigger="hover">
	<span><?php echo $Language->Phrase("ChooseFileBtn") ?></span>
	<input type="file" title=" " data-table="pages_static" data-field="x_image" name="x_image" id="x_image"<?php echo $pages_static->image->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x_image" id= "fn_x_image" value="<?php echo $pages_static->image->Upload->FileName ?>">
...
<input type="hidden" name="fx_x_image" id= "fx_x_image" value="<?php echo $pages_static->image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_image" id= "fm_x_image" value="<?php echo $pages_static->image->UploadMaxFileSize ?>">
</div>
