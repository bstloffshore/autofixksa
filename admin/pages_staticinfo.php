...
class cpages_static extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('pages_static', 'pages_static', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('pages_static', 'pages_static', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title->Sortable = TRUE; // Allow sort
		$this->fields['title'] = &$this->title;

		// title_ar
		$this->title_ar = new cField('pages_static', 'pages_static', 'x_title_ar', 'title_ar', '`title_ar`', '`title_ar`', 200, -1, FALSE, '`title_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title_ar->Sortable = TRUE; // Allow sort
		$this->fields['title_ar'] = &$this->title_ar;

		// summary
		$this->summary = new cField('pages_static', 'pages_static', 'x_summary', 'summary', '`summary`', '`summary`', 200, -1, FALSE, '`summary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->summary->Sortable = TRUE; // Allow sort
		$this->fields['summary'] = &$this->summary;

		// summary_ar
		$this->summary_ar = new cField('pages_static', 'pages_static', 'x_summary_ar', 'summary_ar', '`summary_ar`', '`summary_ar`', 200, -1, FALSE, '`summary_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->summary_ar->Sortable = TRUE; // Allow sort
		$this->fields['summary_ar'] = &$this->summary_ar;

		// image
		$this->image = new cField('pages_static', 'pages_static', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
