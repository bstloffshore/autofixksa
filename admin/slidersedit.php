...
class csliders_edit extends csliders {
	...
	function RestoreFormValues() {
		...
		$this->campaign_start_date->CurrentValue = ew_UnFormatDateTime($this->campaign_start_date->CurrentValue, 7);
		$this->campaign_end_date->CurrentValue = $this->campaign_start_date->FormValue;
		$this->campaign_end_date->CurrentValue = ew_UnFormatDateTime($this->campaign_end_date->CurrentValue, 7);
	...
	function RenderRow() {
		...
		$this->campaign_start_date->ViewValue = ew_FormatDateTime($this->campaign_start_date->ViewValue, 7);
		$this->campaign_start_date->ViewCustomAttributes = "";

		// campaign_end_date
		$this->campaign_end_date->ViewValue = $this->campaign_end_date->CurrentValue;
		$this->campaign_end_date->ViewValue = ew_FormatDateTime($this->campaign_end_date->ViewValue, 7);
		...
		$this->is_general_image->ViewCustomAttributes = "";
			...
			$this->campaign_start_date->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->campaign_start_date->CurrentValue, 7));
			...
			$this->campaign_end_date->EditValue = ew_HtmlEncode(ew_FormatDateTime($this->campaign_end_date->CurrentValue, 7));
...
<?php if ($sliders->campaign_title->Visible) { // campaign_title ?>
	<div id="r_campaign_title" class="form-group">
		<label id="elh_sliders_campaign_title" for="x_campaign_title" class="<?php echo $sliders_edit->LeftColumnClass ?>"><?php echo $sliders->campaign_title->FldCaption() ?></label>
		<div class="<?php echo $sliders_edit->RightColumnClass ?>"><div<?php echo $sliders->campaign_title->CellAttributes() ?>>
...
<?php if ($sliders->campain_slug->Visible) { // campain_slug ?>
	<div id="r_campain_slug" class="form-group">
		<label id="elh_sliders_campain_slug" for="x_campain_slug" class="<?php echo $sliders_edit->LeftColumnClass ?>"><?php echo $sliders->campain_slug->FldCaption() ?></label>
		<div class="<?php echo $sliders_edit->RightColumnClass ?>"><div<?php echo $sliders->campain_slug->CellAttributes() ?>>
...
<?php if ($sliders->campaign_start_date->Visible) { // campaign_start_date ?>
	<div id="r_campaign_start_date" class="form-group">
		<label id="elh_sliders_campaign_start_date" for="x_campaign_start_date" class="<?php echo $sliders_edit->LeftColumnClass ?>"><?php echo $sliders->campaign_start_date->FldCaption() ?></label>
		<div class="<?php echo $sliders_edit->RightColumnClass ?>"><div<?php echo $sliders->campaign_start_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fslidersedit", "x_campaign_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
...
<?php if ($sliders->campaign_end_date->Visible) { // campaign_end_date ?>
	<div id="r_campaign_end_date" class="form-group">
		<label id="elh_sliders_campaign_end_date" for="x_campaign_end_date" class="<?php echo $sliders_edit->LeftColumnClass ?>"><?php echo $sliders->campaign_end_date->FldCaption() ?></label>
		<div class="<?php echo $sliders_edit->RightColumnClass ?>"><div<?php echo $sliders->campaign_end_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fslidersedit", "x_campaign_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
