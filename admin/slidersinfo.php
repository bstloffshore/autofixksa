...
class csliders extends cTable {
	...
	function __construct() {
		...
		// title_ar
		$this->title_ar = new cField('sliders', 'sliders', 'x_title_ar', 'title_ar', '`title_ar`', '`title_ar`', 200, -1, FALSE, '`title_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// summary
		$this->summary = new cField('sliders', 'sliders', 'x_summary', 'summary', '`summary`', '`summary`', 201, -1, FALSE, '`summary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->summary->Sortable = TRUE; // Allow sort
		$this->fields['summary'] = &$this->summary;

		// summary_ar
		$this->summary_ar = new cField('sliders', 'sliders', 'x_summary_ar', 'summary_ar', '`summary_ar`', '`summary_ar`', 201, -1, FALSE, '`summary_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->summary_ar->Sortable = TRUE; // Allow sort
		$this->fields['summary_ar'] = &$this->summary_ar;

		// buttonLabel
		$this->buttonLabel = new cField('sliders', 'sliders', 'x_buttonLabel', 'buttonLabel', '`buttonLabel`', '`buttonLabel`', 200, -1, FALSE, '`buttonLabel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->buttonLabel->Sortable = TRUE; // Allow sort
		$this->fields['buttonLabel'] = &$this->buttonLabel;

		// buttonLabel_ar
		$this->buttonLabel_ar = new cField('sliders', 'sliders', 'x_buttonLabel_ar', 'buttonLabel_ar', '`buttonLabel_ar`', '`buttonLabel_ar`', 200, -1, FALSE, '`buttonLabel_ar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->buttonLabel_ar->Sortable = TRUE; // Allow sort
		$this->fields['buttonLabel_ar'] = &$this->buttonLabel_ar;

		// buttonlinkTo
		$this->buttonlinkTo = new cField('sliders', 'sliders', 'x_buttonlinkTo', 'buttonlinkTo', '`buttonlinkTo`', '`buttonlinkTo`', 200, -1, FALSE, '`buttonlinkTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->buttonlinkTo->Sortable = TRUE; // Allow sort
		$this->fields['buttonlinkTo'] = &$this->buttonlinkTo;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->buttonLabel->setDbValue($rs->fields('buttonLabel'));
		$this->buttonLabel_ar->setDbValue($rs->fields('buttonLabel_ar'));
	...
	function RenderEditRow() {
		...
		$this->buttonLabel->EditValue = $this->buttonLabel->CurrentValue;
		...
		$this->buttonLabel_ar->EditValue = $this->buttonLabel_ar->CurrentValue;
		...
		$this->buttonlinkTo->EditValue = $this->buttonlinkTo->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->buttonLabel->Exportable) $Doc->ExportCaption($this->buttonLabel);
					if ($this->buttonLabel_ar->Exportable) $Doc->ExportCaption($this->buttonLabel_ar);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->buttonLabel->Exportable) $Doc->ExportField($this->buttonLabel);
						if ($this->buttonLabel_ar->Exportable) $Doc->ExportField($this->buttonLabel_ar);
